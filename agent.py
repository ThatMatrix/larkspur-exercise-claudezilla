    ...
    [  # ✏️ Build 2, step 2.1: schemas for the tools you add
        {
            ...
            "description": "Look up the next available day the customer can fly based on their origin, destination, date and cabin.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "origin": {
                    ...
                    "cabin": {
                        "type": "string",
                        "description": "Cabin class code, e.g. Y for economy",
                        "default": "Y",
                    },
                },
...
def fare_rules(section):
    """ """
    text = open("data/americas/fare_rules_excerpt.md").read()
