...
Built: A Claude agent connected to Larkspur's booking, flight status, and policy tools.
Does: Handles rebooking and entitlements for stranded passengers without a human agent.
